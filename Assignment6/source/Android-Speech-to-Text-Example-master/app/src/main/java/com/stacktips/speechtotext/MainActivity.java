            ...
            case REQ_CODE_SPEECH_INPUT: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if (result.get(0).equalsIgnoreCase("Hello")) {
                        ...
                        mVoiceInputTv.setText("My name is Siri. How can I help you?");
                        tts.speak("My name is Siri. How can I help you?",TextToSpeech.QUEUE_FLUSH, null);
                    }
                        ...
                        mVoiceInputTv.setText("Sorry could not recognise.");
                        tts.speak("Sorry could not recognise.",TextToSpeech.QUEUE_FLUSH, null);
                    }
                    break;
                }
